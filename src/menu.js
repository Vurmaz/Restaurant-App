...
(function createMenuItem() {
	const burger1 = new menu('Quatro Burger','15$',' Special Quote Burger with Two Double Burgers','./images/burger1.jpg')
	...
	const burger4 = new menu('Twin Burgers','25$','Two Burgers with Special Twin Sauces','./images/burger4.jpg')
